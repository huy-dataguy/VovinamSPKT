...
const MatchesPage = () => {
  ...
  if (isLoading) return <p className="mt-[80px] text-center">Đang tải danh sách trận đấu...</p>;
  if (isError) return <p className="mt-[80px] text-center text-red-500">ỗi tải dữ liệu trận đấu.</p>;
  return (
