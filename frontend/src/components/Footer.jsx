    ...
    <footer className="bg-gray-900 text-white py-5 px-6 border-t border-gray-800">
      <div className="container mx-auto flex flex-col md:flex-row items-center justify-between gap-6">
        ...
        <a
          ...
          target="_blank"
          rel="noopener noreferrer"
          className="relative overflow-hidden px-8 py-2 rounded-full font-semibold text-white shadow-lg hover:scale-105 transition-transform duration-300"
        >
